...
var Traveller = function (_Person2) {
    ...
    _createClass(Traveller, [{
        key: 'getGreeting',
        value: function getGreeting() {
            var gretting = _get(Traveller.prototype.__proto__ || Object.getPrototypeOf(Traveller.prototype), 'getGreeting', this).call(this);
...
var me = new Traveller('Cansu Pakel', 21, 'Gent');
